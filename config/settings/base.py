...
SECRET_KEY = config('DJANGO_SECRET_KEY', default='insecure-dev-key-change-in-prod')
...
# Внешняя БД КГД (ETL из витрин audit_kpi_data_gold) — задаётся в docker-compose.yml или окружении
